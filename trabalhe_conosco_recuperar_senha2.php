  ...
  <tr>
    <td align="left" valign="bottom" bgcolor="#d9e6ef"><table width="587" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="18">&nbsp;</td>
        <td width="366"><img src="imagens/titulo_trabalhe_conosco.gif" width="297" height="25" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td align="center"><table width="848" cellpadding="0" cellspacing="0">
      <tr>
        <td width="633" height="18" valign="top"><br /></td>
        <td width="163" valign="top">&nbsp;</td>
      </tr>
      <tr>
        <td height="330" colspan="2" align="center" valign="top"><p align="center"></p>
          <p align="center" class="login001"><br />
            Dentro de alguns minutos sua senha ser&aacute; enviada para o e-mail cadastrado conosco. </p>
...
$resultado= mysql_query ("SELECT * FROM tb_socios Where email = '$email'");
...
Olá $nome_completo, foi feita uma solicitação de lembrete de senha através do site www.cursomaispratico.com.br.

A sua senha é: $senha

Esta mensagem foi enviada automaticamente pelo servidor.
...
mail("$email", "Lembrete de Senha",$msg,"From: contato@cursomaispratico.com.br");
