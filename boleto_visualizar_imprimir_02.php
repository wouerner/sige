...
$valor2 = mysql_result ($resultado2, $i, "valor");
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="45%" valign="bottom"><div align="right"><img src="imagens/Logo_Cerbam.jpg" width="181" height="48"></div></td>
      </tr>
      <tr>
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td width="250" height="28" valign="bottom" bgcolor="#FFFFFF" class="style3"><div align="right" class="style1">
            <table width="100%"  border="0" cellpadding="1" cellspacing="0">
              ...
              <tr>
                <td width="96%"><div align="right" class="style3">
...
<table width="699" height="70" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="629" align="right"><p><a target="_self" href="javaScript:window.print()"><img src="imagens/ico_impressora.gif" width="23" height="23" border="0" style='border: 0px; padding: 1px'></a></p></td>
    <td width="70" align="left" class="style3"><a target="_self" href="javaScript:window.print()">Imprimir</a></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
