...
<table width="100%" border="0" align="center">
  ...
  <tr>
    <td height="267" align="center" bgcolor="#FFFFFF"><table width="100%" border="0">
      <tr>
        <td>&nbsp;</td>
      </tr>
    </table>
    <p class="titulos_pagina">&nbsp;</p></td>
    <td width="400" rowspan="3" align="center" valign="top" bgcolor="#FFFFFF"><table width="800" border="0" align="center">
      <tr>
        <td align="center" class="style7 style12"><table width="739" border="0" cellspacing="3" cellpadding="4">
          <tr>
            <td align="center" class="titulo_principal">Editar a P&aacute;gina &quot;Quem Somos&quot; </td>
          </tr>
          <tr>
...
<form action="site_quem_somos_update.php" method="post" >

<?php echo "<input type='hidden' name=id_corp value='$x[id_corp]'>" ?>

<?php
$sBasePath = "/financeiro/fckeditor/" ;
$oFCKeditor = new FCKeditor('quem_somos') ;
$oFCKeditor->BasePath = $sBasePath ;
$oFCKeditor->ToolbarSet = "Basic"; //para usar a barra de formatação completa basta remover esta linha

$oFCKeditor->Value = "$x[quem_somos]" ;
...
?>
 ...
 <?php } ?>
    ...
    <h1 align="center" class="style3">&nbsp;</h1></td>
  ...
  <tr>
    <td height="247" align="center" bgcolor="#FFFFFF">&nbsp;</td>
    <td height="247" align="center" bgcolor="#FFFFFF">&nbsp;</td>
  </tr>
</table>
