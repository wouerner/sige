...
<table width="772" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td width="5" rowspan="2">&nbsp;</td>
    <td width="762" align="center"><table width="739" border="0" cellspacing="3" cellpadding="4">
      <tr>
  ...
  <tr>
    <td valign="top" background="../imagens/corpo_site_05.gif">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3" align="center" valign="top" background="../imagens/corpo_site_066.gif"><?php include "validacao_pagina_adm.php"; ?>
      <p>
        <?php
	  include "validacao_pagina_adm.php"; 
...
$id   = $_POST['id'];
$titulo_pop_up   = $_POST['titulo_pop_up'];
$texto1_pop_up   = $_POST['texto1_pop_up'];
$texto2_pop_up  = $_POST['texto2_pop_up'];
...
titulo_pop_up   = '$titulo_pop_up',
texto1_pop_up   = '$texto1_pop_up',
texto2_pop_up  = '$texto2_pop_up'
...
?>
      ...
      <p class="fonte05">      Cadastro Atualizado com sucesso!      </p></td>
  </tr>
  <tr>
