...
<p align='center' class='titulo_principal'>Tem Certeza que deseja Excluir este Registro ?</p>
            <p align='center'> <a href='parceiros_dados_financeiros_Excluir_registro.php?id_hist_parceiro=$id_hist_parceiro&confirm=sim' target='_self' class='links'>SIM</a></p>
...
<br />
<br />
<p align='center' class='titulo_principal'>O REGISTRO FOI EXCLU&Iacute;DO COM SUCESSO!</p>"; 

//DELETA O REGSTRO DA TABELA ALUNOS
 $query = "DELETE FROM tb_histrico_financeiro_parceiro WHERE id_hist_parceiro = $id_hist_parceiro";
