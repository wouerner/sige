...
$id_aluno_parceiro = $_POST['id_aluno_parceiro'];
...
$query = "Update tb_socios_alunos Set 
...
Where id_aluno_parceiro = '$id_aluno_parceiro'";
...
<p align="center" class="style1"><a href="parceiros_listar_alunos_andamento.php?id_parceiro=<? echo "$id_parceiro" ?>" class="links">Voltar para tela inicial</a> </p>
