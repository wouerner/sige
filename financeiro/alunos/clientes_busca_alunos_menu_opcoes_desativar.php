  <tr>
    ...
    <td bgcolor="#F5FFEC" class="links"><a href="boletim_ver_adcionar_notas.php?id_aluno=<? echo "$x[id_aluno]" ?>"><img src="../imagens/ico_boletim.gif" width="43" height="44" border="0" /></a></td>

    <?php if($nivel == "adm") {?> <td  bgcolor="#F5FFEC" align="center" class="links"><a href="financeiro_lista_Todos_boletos_cada_aluno.php?id_aluno=<? echo "$x[id_aluno]" ?>" title="Verifcar Status Financeiro deste Aluno">
	...
	<td  bgcolor="#F5FFEC" align="center" class="links">
		<a href="financeiro_form_criar_parcelas.php?id_aluno=<? echo "$x[id_aluno]" ?>" target="_self" title="Gerar cobranças para este aluno">
			<img src="../imagens/ico_gerar_pagamento.gif" width="63" height="49" border="0" />
		</a> </td>  
    <?php } ?>

    <td align="center"  bgcolor="#F5FFEC" class="links"><a href="clientes_editar_dados_aluno.php?id_aluno=<? echo "$x[id_aluno]" ?>" title="Editar dados deste deste aluno"><img src="../imagens/ico_editar_dadis.gif" width="37" height="46" border="0" /></a></td>
