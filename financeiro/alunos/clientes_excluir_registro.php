...
<p align='center' class='titulo_principal'>Tem Certeza que deseja Excluir este Aluno ?</p>
            <p align='center'> <a href='clientes_excluir_registro.php?id_aluno=$id_aluno&confirm=sim' target='_self' class='links'>SIM</a></p>
            <p align='center'><a href='javascript:history.back(1)' target='_self' class='links'>CANCELAR</a></p>"; 
...
<br />
<br />
<p align='center' class='titulo_principal'>O ALUNO FOI EXCLU&Iacute;DO COM SUCESSO!</p>"; 

//DELETA O REGSTRO DA TABELA ALUNOS
 $query = "DELETE FROM tb_alunos WHERE id_aluno = $id_aluno";
	           $resultado	=  mysql_query($query);
			   

// DETETA TODOS OS RERISTROS DA TABELA BOLETOS VINCULADO AO ID DO ALUNO
 $query2 = "DELETE FROM tb_boletos_itau WHERE id_aluno = $id_aluno";
	           $resultado2	=  mysql_query($query2);



// DETETA TODOS OS RERISTROS DA TABELA HISTÓRICO FINANCEIRO VINCULADO AO ID DO ALUNO
 $query3 = "DELETE FROM tb_historico_financeiro WHERE id_aluno = $id_aluno";
...
<p align="center" class="style1"><a href="pagina_principal.php" target="_self" class="links">Voltar para tela inicial</a> </p>
