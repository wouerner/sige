...
echo "<p class='fonte_003'>Tem Certeza que deseja Excluir esta Data?</p>
            <p> <a href='agendamento_provas_cadastrar_data_Deletar.php?id_data=$id_data&funcao=sim' target='_self' class='links_001'>SIM</a></p>
...
echo "<p class='fonte_003'>DATA EXCLUÍDA COM SUCESSO!</p>"; 
