...
?>
      <table width="742" border="0" align="center">
		...
		?>
            ...
            <table width="209" height="29" border="0" cellpadding="0" cellspacing="0">
              <tr>
        ...
        <tr>
          <td height="112" align="center" valign="top"><span class="fonte_001"> </span>
              <?  // in&iacute;cio da while, tudo que esta aqui dentro se repete de acordo com o resultado da busca
		  	  // esta while serve para as duas querys que ten logo a cima, os resoltados aqui impressos ser&atilde;o deacordo com cadas busca realizadas pelas condi&ccedil;&otilde;es If.



		  
		  while($x2 = mysql_fetch_array($query))
		  {
		  
		  ?>
              <table width="725" height="42" border="0" align="center" bgcolor="#F8F8F8">
                
                <tr>
                  <td width="87" height="38" align="right" valign="middle" class="fonte02">Data:</td>
                  <td width="530" valign="middle" class="sub_titulos"><strong class="fonte_006">
				  ...
				  ?></strong></td>
                  <td width="94" align="center" valign="middle" ><a class = "btn danger " href="agendamento_provas_cadastrar_data_Deletar.php?id_data=<? echo "$x2[id_data]"; ?>&funcao=nao" target="_self" class="links_001"><img src="imagens/ico_excluir.gif" width="17" height="17" border="0" /><br />
