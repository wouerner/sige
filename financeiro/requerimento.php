...
if (mysql_num_rows($query2)==0) echo "Por favor, atualize os documentos deste aluno, caso contrario não será possivel fazer o requerimento"; 
...
<tr>
	...
	<td align="left">UF:<strong><?php echo "$x2[naturalidade_uf]"; ?></strong> </td>
        <td align="left">Orgão Exp: <strong><?php echo "$x2[rg_orgao]"; ?></strong></td>
</tr>
...
<table>
      <tr>
        <td  rowspan="3" colspan = "2"  align="left" class="vertical">ENDEREÇO:</td>
...
<td  colspan="4" border="0">DOCUMENTAÇÃO</td>
<tr>
...
<tr>
<td></td>
	<td>Cópia - Comprovante de Residência</td>
	<td><strong><?php  echo ($x2['compr_residencia']==true) ?  ("ok"): ("falta"); ?> </strong></td>
<td></td>
<tr>
<td></td>
	<td>Cópia - Comprovante de Reservista
</td>
...
<table>
      ...
      <tr>
        <td width ="50%">Núcleo Bandeirante - DF,____de_________de______  </td>
        <td width ="50%">Núcleo Bandeirante - DF,____de_________de______</td>
      </tr> 
