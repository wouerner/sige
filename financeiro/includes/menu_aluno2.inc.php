<a href="alunos_checar_docs.php?id_aluno=<?php echo $id_aluno ; ?>&codigo_aluno=<?php echo $codigo_aluno ; ?>" title="Editar dados deste deste aluno"><img src="../imagens/docs.gif"></a>
    ...
    <?php if($nivel == "adm") : ?> 
		<a href="../financeiro/financeiro_form_criar_parcelas.php?id_aluno=<?php echo $id_aluno ; ?>&codigo_aluno=<?php echo $codigo_aluno ; ?>" target="_self" title="Gerar cobranças para este aluno">
			<img src="../imagens/ico_gerar_pagamento.gif" width="63" height="49" border="0" />
		</a>  
    <?php endif ; ?>

	<a href="../alunos/clientes_editar_dados_aluno.php?id_aluno=<?php echo $id_aluno ; ?>&codigo_aluno=<?php echo $codigo_aluno ; ?>" title="Editar dados deste deste aluno">
