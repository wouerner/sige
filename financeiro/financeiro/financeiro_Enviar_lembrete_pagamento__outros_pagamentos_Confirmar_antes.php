...
<table width="739" border="0" cellspacing="3" cellpadding="4">
  <tr>
    <td align="center" class="titulo_principal"><p align="center" class="titulo_principal">Tem Certeza que deseja enviar um lembrete de pagamento para:  </p></td>
  </tr>
  <tr>
...
<p>&nbsp;</p>
<p class="fonte05">Deseja enviar Lembrete ?</p>
<table width="258" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="101"><p align="center" class="links style2"><a href="financeiro_Enviar_lembrete_pagamento__outros_pagamentos.php?id_cob=<? echo "$x[id_cob]"; ?>&id_aluno=<? echo "$x[id_aluno]"; ?>" target="_self">SIM</a></p></td>
