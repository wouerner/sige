...
//realiza query na tabela BOLETOS ITAÚ
...
{
$vencimento2 = mysql_result ($resultado2, $i2, "data_vencimento");
...
$valor = mysql_result ($resultado2, $i2, "valor");
}
...
<table width="722" height="336" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="461" align="left"><form name="formulario2" id="formulario2" onSubmit="return ValidaFormulario2()" method="post" action="financeiro_editar_dados_boleto_pagamento_update.php">
      <p><span class="fonte02">Data de Vencimento:</span> <br />
          <input name="vencimento" type="text" class="css_form_02" id="vencimento" title="Digite o Valor a ser Pago" onKeyPress="formatar_mascara(this, '##/##/####')" size="10" maxlength="10" value="<? echo $vencimento ?>"/>
      ...
      <p><span class="fonte02">Valor:</span> <br />
          <input name="valor" type="text" class="css_form_02" id="valor" onKeyPress="return(MascaraMoeda(this,'.','.',event))" value="<? echo $valor ?>" size="10" maxlength="10" onsubmit="return ValidaFormulario2();" />
      </p>
      <p>
