...
?>
  ...
  <table width="733" height="132" border="0" align="center">
    <tr>
      ...
      </span><span class="links"><strong>TODOS PAGAMENTOS  <? echo "$status_pagt"; ?> NO SISTEMA NO PER&Iacute;ODO DE <? echo "$mes" ?>/<? echo "$ano" ?></strong></span></td>
    </tr>
    <tr>
      <td width="557" height="50" align="center" class="links"><span class="fonte03">A soma total deste relat&oacute;rio &eacute; de:</span><strong> R$ 
<?php
...
?></strong></td>
      <td width="166" align="center" class="links"><a href="relatorios_listar_pagamentos_abertos_fechados_gaveta_Mes_Corrente_Impressao.php?status_pagt=<? echo "$status_pagt"; ?>" target="_blank"><img src="imagens/btImprimir.gif" width="29" height="29" border="0"><br>
