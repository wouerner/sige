...
$cod_boleto  = $HTTP_POST_VARS['cod_boleto'];
...
<p align="center" class="fonte05">BOLETO ALTERADO COM SUCESSO!</p>
<p align="center" class="sub_titulos"><span class="links"><strong>Aten&ccedil;&atilde;o!</strong></span> O boleto com as novas informa&ccedil;&otilde;es j&aacute; foram salvas no sistema.<br>
  Agora voc&ecirc; j&aacute; pode re-enviar este boleto ao cliente clicando no link abaixo.</p>
<p align="center"><a href="boleto_itau/boleto_itau.php?cod_boleto=<? echo "$cod_boleto" ?>&id_aluno=<? echo "$id_aluno" ?>&id_cob=<? echo "$id_cob" ?>" target="_blank" class="links"><strong>VISUALIZAR E ENVIAR BOLETO </strong></a></p>

<?php

//atualiza os dados da tabela boletos itau
$query = "Update  tb_boletos_itau Set 

data_vencimento = '$data_invertida',
valor = '$valor'
