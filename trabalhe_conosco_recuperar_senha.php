    ...
    <td align="center"><table width="848" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="330" colspan="2" align="center" valign="top"><p align="center">&nbsp;</p>
          <p align="center" class="login001">Esqueceu sua senha?<br />
            digite seu e-mail cadastrado do campo abaixo e clique em &quot;Recuperar Senha&quot;.</p>
          <form id="form1" name="form1" method="post" action="trabalhe_conosco_recuperar_senha2.php">
            <div align="center">
              <input name="email" type="text" id="email" />
              <input type="submit" name="Submit2" value="Recuperar Senha" />
            </div>
          </form>
          <p align="center"></p></td>
        </tr>
