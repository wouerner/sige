...
<table width="587" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="left" valign="bottom" bgcolor="#d9e6ef"><table width="587" height="40" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="35">&nbsp;</td>
        <td width="552"><img src="imagens/titulo_contrato.gif" width="289" height="26" /></td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    <td valign="top">
	    ...
	    <blockquote class="corpo_texto_geral_01"><?php  	
...
?>
	        ...
	        <textarea name="textarea" cols="80" rows="50"><? echo "$x[corpo_contrato]"; ?></textarea>
...
<table width="464" border="0">
  <tr>
    <td width="128" align="center">  <form id="form1" name="form1" method="get" action="http://www.supletivoceban.com.br/index.php?inicio=current">
  <input type="submit" name="Submit" value="Não Aceito" />
  </form></td>
    <td width="101" align="center">  <form id="form1" name="form1" method="get" action="matricular_agora.php">
  <input type="submit" name="Submit" value="ACEITO" />
  </form></td>
    <td width="213" align="center"><form id="form1" name="form1" method="get" action="imprimir_contrato_aceitacao.php">
  <input type="submit" name="Submit" value="Imprimir Contrato" />
  </form></td>
  </tr>
</table>
<p>&nbsp;</p>
