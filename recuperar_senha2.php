...
<table width="100%" height="734" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="left" valign="bottom" bgcolor="#d9e6ef">&nbsp;</td>
  </tr>
  <tr>
...
$resultado= mysql_query ("SELECT * FROM tb_alunos Where email = '$email'");
...
Olá $nome_completo, foi feita uma solicitação de lembrete de senha através do site www.cursoglobal.net.
...
mail("$email", "Lembrete de Senha",$msg,"From: cursos@cursoglobal.net");
