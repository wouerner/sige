...
<table width="587" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="left" valign="bottom" bgcolor="#d9e6ef"><table width="587" height="40" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="35">&nbsp;</td>
        <td width="552"><img src="imagens/titulo_quem_somos.gif" width="200" height="31" /></td>
      </tr>
    </table></td>
  </tr>
...
?>
	            ...
	            <span class="css_corpo_site"><? echo "$x[quem_somos]"; ?></span>
                    <?php } ?>
	              <?php mysql_close($link); ?></blockquote>
	  </blockquote></td>
  </tr>
</table>
